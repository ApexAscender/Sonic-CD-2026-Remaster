...
// AUTO-GENERATED from WaterStreamL.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_WaterStreamL::ObjectStartup()
{
...
void O_R4_WaterStreamL::ObjectPlayerInteraction()
{
    Entity *self = Self();
