...
// AUTO-GENERATED from VOBlocks.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_VOBlocks::ObjectStartup()
{
...
void O_R4_VOBlocks::ObjectPlayerInteraction()
{
    Entity *self = Self();
