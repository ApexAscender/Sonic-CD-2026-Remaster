...
#include "O_R5_HPlatformMedium1.hpp"
...
// AUTO-GENERATED from HPlatformMedium1.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R5_HPlatformMedium1::ObjectStartup()
{
...
void O_R5_HPlatformMedium1::ObjectMain()
{
    Entity *self = Self();
...
void O_R5_HPlatformMedium1::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R5_HPlatformMedium1::ObjectDraw()
{
    Entity *self = Self();
