...
// AUTO-GENERATED from R81CSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R8_R81CSetup::ObjectStartup()
{
    ...
    while (scriptEng.tempValue[0] < 6) {
        LoadPalette("R81C_PalCycle.act", scriptEng.tempValue[0], 160, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R8_R81CSetup::ObjectMain()
{
    Entity *self = Self();
