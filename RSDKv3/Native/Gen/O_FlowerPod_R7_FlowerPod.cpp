...
#include "O_FlowerPod_R7_FlowerPod.hpp"
...
// AUTO-GENERATED from R7_FlowerPod.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_FlowerPod_R7_FlowerPod::ObjectStartup()
{
...
void O_FlowerPod_R7_FlowerPod::ObjectMain()
{
    Entity *self = Self();
...
void O_FlowerPod_R7_FlowerPod::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_FlowerPod_R7_FlowerPod::ObjectDraw()
{
    Entity *self = Self();
