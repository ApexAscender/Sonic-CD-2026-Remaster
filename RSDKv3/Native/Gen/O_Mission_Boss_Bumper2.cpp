...
#include "O_Mission_Boss_Bumper2.hpp"
...
// AUTO-GENERATED from Boss_Bumper2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_Boss_Bumper2::ObjectStartup()
{
...
void O_Mission_Boss_Bumper2::ObjectMain()
{
    Entity *self = Self();
...
void O_Mission_Boss_Bumper2::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_Mission_Boss_Bumper2::ObjectDraw()
{
    Entity *self = Self();
