...
#include "O_TitleCards_R4_TitleCard.hpp"
...
// AUTO-GENERATED from R4_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R4_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    if (GVar("Options.Soundtrack") == 0) {
        ...
        switch (objectEntityList[24].propertyValue) {
            case 0:
            SetMusicTrack_Script("US/R4A.ogg", 0, 415148);
            break;
            case 1:
            SetMusicTrack_Script("R4B.ogg", 0, 1);
            break;
            case 2:
            SetMusicTrack_Script("US/R4C.ogg", 0, 1);
            break;
            case 3:
            SetMusicTrack_Script("US/R4D.ogg", 0, 145616);
            break;
        }
    }
    ...
    AddSpriteFrame(0, 0, 16, 56, 83, 132);
    AddSpriteFrame(12, 33, 6, 23, 169, 108);
    AddSpriteFrame(19, 33, 11, 23, 76, 84);
    AddSpriteFrame(31, 33, 11, 23, 43, 84);
    AddSpriteFrame(43, 33, 9, 23, 159, 84);
    AddSpriteFrame(0, 56, 16, 56, 83, 132);
    AddSpriteFrame(16, 57, 9, 23, 88, 84);
    AddSpriteFrame(26, 57, 17, 23, 169, 84);
    AddSpriteFrame(44, 57, 10, 23, 211, 84);
    AddSpriteFrame(54, 57, 9, 23, 88, 84);
    AddSpriteFrame(63, 57, 10, 23, 70, 108);
    AddSpriteFrame(73, 57, 10, 23, 81, 108);
}

void O_TitleCards_R4_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R4_TitleCard::ObjectDraw()
{
    Entity *self = Self();
