...
#include "O_TitleCards_R7_TitleCard.hpp"
...
// AUTO-GENERATED from R7_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R7_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    if (GVar("Options.Soundtrack") == 0) {
        ...
        switch (objectEntityList[24].propertyValue) {
            case 0:
            SetMusicTrack_Script("US/R7A.ogg", 0, 617728);
            break;
            case 1:
            SetMusicTrack_Script("R7B.ogg", 0, 730678);
            break;
    ...
    objectEntityList[20].values[1] += objectEntityList[20].values[7];
    objectEntityList[20].values[2] = 16;
    ...
    AddSpriteFrame(0, 0, 16, 55, 142, 133);
    AddSpriteFrame(16, 32, 10, 23, 81, 108);
    AddSpriteFrame(26, 32, 11, 23, 43, 84);
    AddSpriteFrame(38, 32, 12, 23, 57, 108);
    AddSpriteFrame(51, 32, 11, 23, 76, 84);
    AddSpriteFrame(63, 32, 11, 23, 92, 108);
    AddSpriteFrame(75, 32, 10, 23, 70, 108);
    AddSpriteFrame(85, 32, 10, 23, 81, 108);
    AddSpriteFrame(0, 56, 16, 55, 142, 133);
    AddSpriteFrame(16, 56, 10, 23, 211, 84);
    AddSpriteFrame(26, 56, 9, 23, 88, 84);
    AddSpriteFrame(35, 56, 9, 23, 88, 84);
    AddSpriteFrame(44, 56, 11, 23, 76, 84);
    AddSpriteFrame(55, 56, 17, 23, 116, 108);
    AddSpriteFrame(73, 56, 11, 23, 43, 84);
    AddSpriteFrame(84, 56, 11, 23, 146, 108);
}

void O_TitleCards_R7_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R7_TitleCard::ObjectDraw()
{
    Entity *self = Self();
