...
void O_R6_PushButton::ObjectStartup()
{
    LoadSpriteSheet("R6/Objects.gif");
    AddSpriteFrame(-16, -8, 32, 16, 140, 1);
    AddSpriteFrame(-16, 0, 32, 8, 140, 18);
}

void O_R6_PushButton::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R6_PushButton::ObjectDraw()
{
    Entity *self = Self();
