...
// AUTO-GENERATED from WaterStreamR.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_WaterStreamR::ObjectStartup()
{
...
void O_R4_WaterStreamR::ObjectPlayerInteraction()
{
    Entity *self = Self();
