...
#include "O_Mission_MissionPastPost.hpp"
...
// AUTO-GENERATED from MissionPastPost.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_MissionPastPost::ObjectStartup()
{
...
void O_Mission_MissionPastPost::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_Mission_MissionPastPost::ObjectDraw()
{
    Entity *self = Self();
