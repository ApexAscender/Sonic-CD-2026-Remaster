...
// AUTO-GENERATED from Spotlights2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R7_Spotlights2::ObjectStartup()
{
...
void O_R7_Spotlights2::ObjectMain()
{
    Entity *self = Self();
...
void O_R7_Spotlights2::ObjectDraw()
{
    Draw3DScene_Script();
}

void O_R7_Spotlights2::Spotlights_UpdateCorner()
{
    Entity *self = Self();
...
const Native::NativeFunctionDef O_R7_Spotlights2::funcs[1] = {
    { "Spotlights_UpdateCorner", O_R7_Spotlights2::Spotlights_UpdateCorner },
};
