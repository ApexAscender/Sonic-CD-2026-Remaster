...
#include "O_Mission_PlatformBlock.hpp"
...
// AUTO-GENERATED from PlatformBlock.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_PlatformBlock::ObjectStartup()
{
    LoadSpriteSheet("Mission/Objects.gif");
    AddSpriteFrame(-16, -16, 32, 32, 1, 1);
}

void O_Mission_PlatformBlock::ObjectPlayerInteraction()
{
    Entity *self = Self();
    ...
    if (self->propertyValue <= 1) {
        ...
        PlayerObjectCollision(C_PLATFORM, -16, -16, scriptEng.tempValue[0], 16);
    }
}

void O_Mission_PlatformBlock::ObjectDraw()
{
    Entity *self = Self();
