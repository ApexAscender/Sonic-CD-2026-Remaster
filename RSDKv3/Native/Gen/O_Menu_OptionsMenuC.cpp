...
#include "O_Menu_OptionsMenuC.hpp"
...
// AUTO-GENERATED from OptionsMenuC.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Menu_OptionsMenuC::ObjectStartup()
{
    ...
    AddSpriteFrame(64, 12, 128, 16, 1, 530);
    AddSpriteFrame(64, 12, 128, 16, 1, 290);
    AddSpriteFrame(64, 12, 128, 16, 1, 205);
    AddSpriteFrame(64, 12, 128, 16, 1, 222);
    AddSpriteFrame(64, 12, 128, 16, 130, 530);
    AddSpriteFrame(64, 12, 128, 16, 130, 290);
...
void O_Menu_OptionsMenuC::ObjectMain()
{
    Entity *self = Self();
...
void O_Menu_OptionsMenuC::ObjectDraw()
{
    Entity *self = Self();
...
void O_Menu_OptionsMenuC::OptionsMenuC_DrawOptions()
{
    Entity *self = Self();
...
const Native::NativeFunctionDef O_Menu_OptionsMenuC::funcs[1] = {
    { "OptionsMenuC_DrawOptions", O_Menu_OptionsMenuC::OptionsMenuC_DrawOptions },
};
