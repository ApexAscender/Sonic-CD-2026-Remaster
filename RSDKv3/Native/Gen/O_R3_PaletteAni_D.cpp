...
void O_R3_PaletteAni_D::ObjectStartup()
{
    ...
    while (scriptEng.tempValue[0] < 6) {
        LoadPalette("R3D_PalCycle.act", scriptEng.tempValue[0], 160, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R3_PaletteAni_D::ObjectMain()
{
    Entity *self = Self();
