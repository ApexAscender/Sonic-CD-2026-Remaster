...
// AUTO-GENERATED from PohBee3.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_PohBee3::ObjectStartup()
{
    ...
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("PohBee3")) {
...
void O_Mission_PohBee3::ObjectMain()
{
    Entity *self = Self();
...
void O_Mission_PohBee3::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_Mission_PohBee3::ObjectDraw()
{
    Entity *self = Self();
