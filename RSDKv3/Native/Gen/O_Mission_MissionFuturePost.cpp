...
#include "O_Mission_MissionFuturePost.hpp"
...
// AUTO-GENERATED from MissionFuturePost.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_MissionFuturePost::ObjectStartup()
{
...
void O_Mission_MissionFuturePost::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_Mission_MissionFuturePost::ObjectDraw()
{
    Entity *self = Self();
