...
#include "O_TitleCards_R2_TitleCard.hpp"
...
// AUTO-GENERATED from R2_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R2_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    AddSpriteFrame(0, 0, 17, 55, 180, 133);
    AddSpriteFrame(18, 32, 9, 23, 88, 84);
    AddSpriteFrame(28, 32, 10, 23, 70, 108);
    AddSpriteFrame(39, 32, 9, 23, 88, 84);
    AddSpriteFrame(49, 32, 12, 23, 57, 108);
    AddSpriteFrame(62, 32, 10, 23, 81, 108);
    AddSpriteFrame(0, 56, 17, 55, 180, 133);
    AddSpriteFrame(18, 56, 11, 23, 43, 84);
    AddSpriteFrame(30, 56, 10, 23, 158, 108);
    AddSpriteFrame(41, 56, 10, 23, 158, 108);
    AddSpriteFrame(52, 56, 9, 23, 159, 84);
    AddSpriteFrame(62, 56, 9, 23, 88, 84);
}

void O_TitleCards_R2_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R2_TitleCard::ObjectDraw()
{
    Entity *self = Self();
