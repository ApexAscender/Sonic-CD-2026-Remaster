...
#include "O_Mission_BataPyon2.hpp"
...
// AUTO-GENERATED from BataPyon2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_BataPyon2::ObjectStartup()
{
    ...
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("Bata Pyon")) {
            objectEntityList[scriptEng.arrayPosition[0]].type = TypeNameID("BataPyon2");
        }
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("BataPyon2")) {
            ...
            objectEntityList[scriptEng.arrayPosition[0]].values[1] = -0x14000;
            objectEntityList[scriptEng.arrayPosition[0]].values[2] = 0x100000;
        }
        scriptEng.arrayPosition[0]++;
    }
}

void O_Mission_BataPyon2::ObjectMain()
{
    Entity *self = Self();
...
void O_Mission_BataPyon2::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_Mission_BataPyon2::ObjectDraw()
{
    Entity *self = Self();
