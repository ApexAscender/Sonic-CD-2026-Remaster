...
void O_R8_PushButton::ObjectStartup()
{
    LoadSpriteSheet("R8/Objects.gif");
    AddSpriteFrame(-16, -8, 32, 16, 142, 98);
    AddSpriteFrame(-16, 0, 32, 8, 142, 114);
}

void O_R8_PushButton::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R8_PushButton::ObjectDraw()
{
    Entity *self = Self();
