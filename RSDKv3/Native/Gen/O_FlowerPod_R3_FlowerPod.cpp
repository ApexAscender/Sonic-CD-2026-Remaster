...
#include "O_FlowerPod_R3_FlowerPod.hpp"
...
// AUTO-GENERATED from R3_FlowerPod.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_FlowerPod_R3_FlowerPod::ObjectStartup()
{
...
void O_FlowerPod_R3_FlowerPod::ObjectMain()
{
    Entity *self = Self();
...
void O_FlowerPod_R3_FlowerPod::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_FlowerPod_R3_FlowerPod::ObjectDraw()
{
    Entity *self = Self();
