...
void O_R1_VPlatform::ObjectStartup()
{
    LoadSpriteSheet("R1/Objects.gif");
    AddSpriteFrame(-32, -16, 64, 32, 101, 109);
}

void O_R1_VPlatform::ObjectMain()
{
    Entity *self = Self();
...
void O_R1_VPlatform::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R1_VPlatform::ObjectDraw()
{
    Entity *self = Self();
