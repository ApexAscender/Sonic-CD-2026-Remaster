...
#include "O_TitleCards_R1_TitleCard.hpp"
...
// AUTO-GENERATED from R1_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R1_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    if (GVar("Options.Soundtrack") == 0) {
        ...
        switch (objectEntityList[24].propertyValue) {
            case 0:
            SetMusicTrack_Script("US/R1A.ogg", 0, 153038);
            break;
            case 1:
            SetMusicTrack_Script("R1B.ogg", 0, 354890);
            break;
            case 2:
            SetMusicTrack_Script("US/R1C.ogg", 0, 152346);
            break;
            case 3:
            SetMusicTrack_Script("US/R1D.ogg", 0, 774998);
            break;
        }
    }
    ...
    objectEntityList[20].values[1] += objectEntityList[20].values[7];
    objectEntityList[20].values[2] = 13;
    ...
    AddSpriteFrame(0, 0, 24, 56, 41, 132);
    AddSpriteFrame(24, 32, 11, 23, 43, 84);
    AddSpriteFrame(36, 32, 9, 23, 159, 84);
    AddSpriteFrame(45, 32, 17, 23, 169, 84);
    AddSpriteFrame(62, 32, 10, 23, 81, 108);
    AddSpriteFrame(72, 32, 12, 23, 57, 108);
    AddSpriteFrame(84, 32, 9, 23, 88, 84);
    AddSpriteFrame(93, 32, 9, 23, 88, 84);
    AddSpriteFrame(0, 56, 24, 56, 41, 132);
    AddSpriteFrame(24, 56, 11, 23, 43, 84);
    AddSpriteFrame(36, 56, 11, 23, 187, 84);
    AddSpriteFrame(48, 56, 5, 23, 131, 84);
    AddSpriteFrame(54, 56, 8, 23, 67, 84);
}

void O_TitleCards_R1_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R1_TitleCard::ObjectDraw()
{
    Entity *self = Self();
