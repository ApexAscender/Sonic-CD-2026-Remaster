...
// AUTO-GENERATED from CLedge2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R1_CLedge2::ObjectStartup()
{
    LoadSpriteSheet("R1/Objects2.gif");
    AddSpriteFrame(-40, -40, 80, 80, 82, 1);
    scriptEng.tempValue[1] = 82;
    while (scriptEng.tempValue[1] < 162) {
...
void O_R1_CLedge2::ObjectPlayerInteraction()
{
    Entity *self = Self();
            ...
            if (CheckResult() == 1) {
                ...
                while (scriptEng.tempValue[1] < 5) {
                    ...
                    while (scriptEng.tempValue[2] < 5) {
                        CreateTempObject(TypeNameID("Crumble Ledge 2"), scriptEng.tempValue[0], scriptEng.tempValue[4], scriptEng.tempValue[5]);
