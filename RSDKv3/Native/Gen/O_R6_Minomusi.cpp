...
// AUTO-GENERATED from Minomusi.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R6_Minomusi::ObjectStartup()
{
...
void O_R6_Minomusi::ObjectPlayerInteraction()
{
    Entity *self = Self();
