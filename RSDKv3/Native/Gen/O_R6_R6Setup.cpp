...
// AUTO-GENERATED from R6Setup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R6_R6Setup::ObjectStartup()
{
...
void O_R6_R6Setup::ObjectPlayerInteraction()
{
    Entity *self = Self();
