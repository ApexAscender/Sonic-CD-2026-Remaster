...
#include "O_FlowerPod_R1_FlowerPod.hpp"
...
// AUTO-GENERATED from R1_FlowerPod.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_FlowerPod_R1_FlowerPod::ObjectStartup()
{
    LoadSpriteSheet("R1/Objects3.gif");
    AddSpriteFrame(-32, 6, 64, 42, 191, 140);
    AddSpriteFrame(-32, -48, 64, 54, 191, 86);
    AddSpriteFrame(-32, -48, 64, 54, 191, 183);
    AddSpriteFrame(-32, -10, 64, 16, 191, 238);
...
void O_FlowerPod_R1_FlowerPod::ObjectMain()
{
    Entity *self = Self();
...
void O_FlowerPod_R1_FlowerPod::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_FlowerPod_R1_FlowerPod::ObjectDraw()
{
    Entity *self = Self();
