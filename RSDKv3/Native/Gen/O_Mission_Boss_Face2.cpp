...
#include "O_Mission_Boss_Face2.hpp"
...
// AUTO-GENERATED from Boss_Face2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_Boss_Face2::ObjectStartup()
{
    ...
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("Boss Face")) {
            objectEntityList[scriptEng.arrayPosition[0]].type = TypeNameID("BossFace2");
...
void O_Mission_Boss_Face2::ObjectMain()
{
    Entity *self = Self();
    ...
    switch (self->state) {
        ...
        if (self->rotation < 120) {
            ...
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossBody2"), self->propertyValue, self->XPos, self->YPos);
            ...
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossLegJoint2"), self->propertyValue, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            objectEntityList[scriptEng.arrayPosition[0]].values[0] = objectLoop;
            ...
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossLeg2"), self->propertyValue, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            objectEntityList[scriptEng.arrayPosition[0]].values[0] = objectLoop;
            ...
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossFoot2"), self->propertyValue, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            objectEntityList[scriptEng.arrayPosition[0]].values[0] = objectLoop;
            ...
            objectEntityList[scriptEng.arrayPosition[0]].values[1] += 1;
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossShoulder"), 0, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            ...
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossArmJoint2"), self->propertyValue, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            objectEntityList[scriptEng.arrayPosition[0]].values[0] = objectLoop;
            ...
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossArm2"), self->propertyValue, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            objectEntityList[scriptEng.arrayPosition[0]].values[0] = objectLoop;
            ...
            scriptEng.arrayPosition[0]++;
            ResetObjectEntity(scriptEng.arrayPosition[0], TypeNameID("BossBumper2"), self->propertyValue, self->XPos, self->YPos);
            objectEntityList[scriptEng.arrayPosition[0]].priority = 1;
            objectEntityList[scriptEng.arrayPosition[0]].values[0] = objectLoop;
...
void O_Mission_Boss_Face2::ObjectPlayerInteraction()
{
    Entity *self = Self();
        ...
        if (pAnimation() != GVar("ANI_HURT")) {
            if (self->values[3] < 3) {
                ...
                if (CheckResult() == 1) {
                    ...
                    CheckResult() = (pAnimation() == GVar("ANI_HAMMER_JUMP"));
                    scriptEng.tempValue[2] |= CheckResult();
                    CheckResult() = (pAnimation() == GVar("ANI_HAMMER_DASH"));
                    scriptEng.tempValue[2] |= CheckResult();
...
void O_Mission_Boss_Face2::ObjectDraw()
{
    Entity *self = Self();
...
void O_Mission_Boss_Face2::R1_EGGMAN2_Oscillation()
{
    Entity *self = Self();
...
const Native::NativeFunctionDef O_Mission_Boss_Face2::funcs[1] = {
    { "R1_EGGMAN2_Oscillation", O_Mission_Boss_Face2::R1_EGGMAN2_Oscillation },
};
