...
// AUTO-GENERATED from TileTriggerV.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R1_TileTriggerV::ObjectStartup()
{
    scriptEng.arrayPosition[0] = 32;
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("Tile Trigger V")) {
...
void O_R1_TileTriggerV::ObjectPlayerInteraction()
{
    Entity *self = Self();
