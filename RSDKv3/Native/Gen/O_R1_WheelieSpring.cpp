...
#include "O_R1_WheelieSpring.hpp"
...
void O_R1_WheelieSpring::ObjectStartup()
{
...
void O_R1_WheelieSpring::ObjectMain()
{
    Entity *self = Self();
...
void O_R1_WheelieSpring::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R1_WheelieSpring::ObjectDraw()
{
    Entity *self = Self();
