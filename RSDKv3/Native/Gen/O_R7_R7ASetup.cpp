...
// AUTO-GENERATED from R7ASetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R7_R7ASetup::ObjectStartup()
{
    ...
    while (scriptEng.tempValue[0] < 2) {
        LoadPalette("R7A_PalCycle.act", scriptEng.tempValue[0], 160, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R7_R7ASetup::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R7_R7ASetup::R7Setup_GetLoopTileInfo()
{
    scriptEng.tempValue[3] = pXPos();
    scriptEng.tempValue[3] >>= 16;
...
const Native::NativeFunctionDef O_R7_R7ASetup::funcs[1] = {
    { "R7Setup_GetLoopTileInfo", O_R7_R7ASetup::R7Setup_GetLoopTileInfo },
};
