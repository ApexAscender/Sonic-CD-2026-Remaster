...
// AUTO-GENERATED from R7DSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R7_R7DSetup::ObjectStartup()
{
...
void O_R7_R7DSetup::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R7_R7DSetup::R7Setup_GetLoopTileInfo()
{
    scriptEng.tempValue[3] = pXPos();
    scriptEng.tempValue[3] >>= 16;
...
const Native::NativeFunctionDef O_R7_R7DSetup::funcs[1] = {
    { "R7Setup_GetLoopTileInfo", O_R7_R7DSetup::R7Setup_GetLoopTileInfo },
};
