...
#include "O_R5_HPlatformLarge.hpp"
...
// AUTO-GENERATED from HPlatformLarge.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R5_HPlatformLarge::ObjectStartup()
{
...
void O_R5_HPlatformLarge::ObjectMain()
{
    Entity *self = Self();
    ...
    switch (self->propertyValue) {
        ...
        objectEntityList[objectLoop + 3].XPos = self->values[4];
        objectEntityList[objectLoop + 3].XPos += 0x200000;
        objectEntityList[objectLoop + 3].YPos = self->YPos;
        objectEntityList[objectLoop + 3].YPos -= 0x180000;
        self->values[4] -= self->values[3];
        break;
        case 4:
        self->values[4] *= -0x1800;
...
void O_R5_HPlatformLarge::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R5_HPlatformLarge::ObjectDraw()
{
    Entity *self = Self();
