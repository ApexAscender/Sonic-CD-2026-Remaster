...
// AUTO-GENERATED from BGEffectsA1.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_BGEffectsA1::ObjectStartup()
{
...
void O_R4_BGEffectsA1::ObjectDraw()
{
    Entity *self = Self();
    ...
    if (self->values[0] > 1) {
        ...
        stageLayouts[2].deformationOffsetW++;
        self->values[0] = 0;
    }
...
void O_R4_BGEffectsA1::BGEffects_Deform_Left()
{
...
void O_R4_BGEffectsA1::BGEffects_Deform_Right()
{
    bgDeformationData1[scriptEng.arrayPosition[0]] = -1;
    scriptEng.arrayPosition[0]++;
    bgDeformationData1[scriptEng.arrayPosition[0]] = -1;
...
const Native::NativeFunctionDef O_R4_BGEffectsA1::funcs[2] = {
    { "BGEffects_Deform_Left", O_R4_BGEffectsA1::BGEffects_Deform_Left },
    { "BGEffects_Deform_Right", O_R4_BGEffectsA1::BGEffects_Deform_Right },
};
