...
// AUTO-GENERATED from R7BSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R7_R7BSetup::ObjectStartup()
{
...
void O_R7_R7BSetup::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R7_R7BSetup::R7Setup_GetLoopTileInfo()
{
    scriptEng.tempValue[3] = pXPos();
    scriptEng.tempValue[3] >>= 16;
...
const Native::NativeFunctionDef O_R7_R7BSetup::funcs[1] = {
    { "R7Setup_GetLoopTileInfo", O_R7_R7BSetup::R7Setup_GetLoopTileInfo },
};
