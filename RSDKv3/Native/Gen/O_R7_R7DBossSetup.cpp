...
// AUTO-GENERATED from R7DBossSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R7_R7DBossSetup::ObjectStartup()
{
    ...
    AddSpriteFrame(-24, -24, 48, 24, 173, 26);
    AddSpriteFrame(-8, 0, 16, 224, 222, 26);
    AddSpriteFrame(-8, 224, 16, 224, 222, 26);
    AddSpriteFrame(-8, 448, 16, 224, 222, 26);
    xBoundary2 -= 288;
    CopyPalette(0, 1);
    CopyPalette(0, 2);
    CopyPalette(0, 3);
    ...
    while (scriptEng.tempValue[0] < 6) {
        LoadPalette("R7D_PalCycle.act", scriptEng.tempValue[0], 160, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R7_R7DBossSetup::ObjectMain()
{
    Entity *self = Self();
...
void O_R7_R7DBossSetup::ObjectPlayerInteraction()
{
...
void O_R7_R7DBossSetup::ObjectDraw()
{
    Entity *self = Self();
...
void O_R7_R7DBossSetup::R7Setup_GetLoopTileInfo()
{
...
const Native::NativeFunctionDef O_R7_R7DBossSetup::funcs[1] = {
    { "R7Setup_GetLoopTileInfo", O_R7_R7DBossSetup::R7Setup_GetLoopTileInfo },
};
