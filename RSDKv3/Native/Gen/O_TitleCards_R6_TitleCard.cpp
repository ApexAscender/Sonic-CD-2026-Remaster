...
#include "O_TitleCards_R6_TitleCard.hpp"
...
// AUTO-GENERATED from R6_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R6_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    if (GVar("Options.Soundtrack") == 0) {
        ...
        switch (objectEntityList[24].propertyValue) {
            case 0:
            SetMusicTrack_Script("US/R6A.ogg", 0, 926048);
            break;
            case 1:
            SetMusicTrack_Script("R6B.ogg", 0, 1);
            break;
            case 2:
            SetMusicTrack_Script("US/R6C.ogg", 0, 181704);
            break;
            case 3:
            SetMusicTrack_Script("US/R6D.ogg", 0, 45355);
            break;
        }
    }
    ...
    AddSpriteFrame(108, 32, 24, 48, 188, 1);
    AddSpriteFrame(0, 0, 20, 55, 121, 133);
    AddSpriteFrame(20, 32, 11, 23, 43, 84);
    AddSpriteFrame(32, 32, 9, 23, 176, 108);
    AddSpriteFrame(41, 32, 11, 23, 147, 84);
    AddSpriteFrame(53, 32, 11, 23, 146, 108);
    AddSpriteFrame(0, 56, 20, 55, 121, 133);
    AddSpriteFrame(20, 56, 11, 23, 199, 84);
    AddSpriteFrame(32, 56, 12, 23, 57, 108);
    AddSpriteFrame(44, 56, 11, 23, 147, 84);
    AddSpriteFrame(56, 56, 11, 23, 55, 84);
    AddSpriteFrame(67, 56, 9, 23, 88, 84);
    AddSpriteFrame(76, 56, 11, 23, 187, 84);
    AddSpriteFrame(88, 56, 9, 23, 176, 108);
    AddSpriteFrame(97, 56, 11, 23, 119, 84);
}

void O_TitleCards_R6_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R6_TitleCard::ObjectDraw()
{
    Entity *self = Self();
