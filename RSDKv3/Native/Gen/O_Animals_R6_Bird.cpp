...
// AUTO-GENERATED from R6_Bird.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Animals_R6_Bird::ObjectStartup()
{
    LoadSpriteSheet("R6/Objects.gif");
    AddSpriteFrame(-12, -8, 24, 16, 197, 34);
    AddSpriteFrame(-12, -8, 24, 16, 197, 51);
...
void O_Animals_R6_Bird::ObjectMain()
{
    Entity *self = Self();
...
void O_Animals_R6_Bird::ObjectDraw()
{
    Entity *self = Self();
