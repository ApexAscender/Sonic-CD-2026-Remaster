...
// AUTO-GENERATED from R82DSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R8_R82DSetup::ObjectStartup()
{
    ...
    while (scriptEng.tempValue[0] < 6) {
        LoadPalette("R82D_PalCycle.act", scriptEng.tempValue[0], 160, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R8_R82DSetup::ObjectMain()
{
    Entity *self = Self();
...
void O_R8_R82DSetup::ObjectPlayerInteraction()
{
