...
// AUTO-GENERATED from R83DSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R8_R83DSetup::ObjectStartup()
{
    ...
    while (scriptEng.tempValue[0] < 6) {
        LoadPalette("R83D_PalCycle.act", scriptEng.tempValue[0], 160, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R8_R83DSetup::ObjectMain()
{
    Entity *self = Self();
    ...
    if (scriptEng.tempValue[0] == 0) {
        ...
        Copy16x16Tile(396, scriptEng.tempValue[0]);
    }
    self->values[5]++;
    self->values[5] %= 56;
    self->values[0]++;
...
void O_R8_R83DSetup::ObjectPlayerInteraction()
{
