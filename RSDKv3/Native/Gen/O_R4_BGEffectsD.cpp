...
// AUTO-GENERATED from BGEffectsD.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_BGEffectsD::ObjectStartup()
{
...
void O_R4_BGEffectsD::ObjectDraw()
{
    Entity *self = Self();
...
void O_R4_BGEffectsD::BGEffects_Deform_Left()
{
...
void O_R4_BGEffectsD::BGEffects_Deform_Right()
{
    bgDeformationData1[scriptEng.arrayPosition[0]] = -1;
    scriptEng.arrayPosition[0]++;
    bgDeformationData1[scriptEng.arrayPosition[0]] = -1;
...
const Native::NativeFunctionDef O_R4_BGEffectsD::funcs[2] = {
    { "BGEffects_Deform_Left", O_R4_BGEffectsD::BGEffects_Deform_Left },
    { "BGEffects_Deform_Right", O_R4_BGEffectsD::BGEffects_Deform_Right },
};
