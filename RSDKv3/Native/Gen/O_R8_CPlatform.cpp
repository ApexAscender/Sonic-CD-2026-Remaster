...
void O_R8_CPlatform::ObjectStartup()
{
    LoadSpriteSheet("R8/Objects.gif");
    AddSpriteFrame(-8, -16, 16, 32, 222, 212);
    AddSpriteFrame(-8, -8, 16, 16, 222, 212);
    AddSpriteFrame(-8, -8, 16, 16, 222, 228);
...
void O_R8_CPlatform::ObjectMain()
{
    Entity *self = Self();
...
void O_R8_CPlatform::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R8_CPlatform::ObjectDraw()
{
    Entity *self = Self();
