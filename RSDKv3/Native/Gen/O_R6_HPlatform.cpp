...
void O_R6_HPlatform::ObjectStartup()
{
    ...
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("H Platform")) {
...
void O_R6_HPlatform::ObjectMain()
{
    Entity *self = Self();
...
void O_R6_HPlatform::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R6_HPlatform::ObjectDraw()
{
    Entity *self = Self();
