...
// AUTO-GENERATED from R8_Bird.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Animals_R8_Bird::ObjectStartup()
{
...
void O_Animals_R8_Bird::ObjectMain()
{
    Entity *self = Self();
...
void O_Animals_R8_Bird::ObjectDraw()
{
    Entity *self = Self();
