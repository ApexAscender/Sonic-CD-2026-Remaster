...
void O_R4_CPlatform::ObjectStartup()
{
    LoadSpriteSheet("R4/Objects.gif");
    AddSpriteFrame(-8, -16, 16, 32, 1, 198);
    AddSpriteFrame(-8, -8, 16, 16, 1, 198);
...
void O_R4_CPlatform::ObjectMain()
{
    Entity *self = Self();
...
void O_R4_CPlatform::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R4_CPlatform::ObjectDraw()
{
    Entity *self = Self();
