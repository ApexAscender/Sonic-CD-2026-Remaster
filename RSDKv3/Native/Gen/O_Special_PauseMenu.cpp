...
#include "O_Special_PauseMenu.hpp"
...
void O_Special_PauseMenu::ObjectStartup()
{
    ...
    if (playerListPos == 0) {
        AddSpriteFrame(-28, -14, 16, 24, 1, 231);
        AddSpriteFrame(-28, -14, 16, 24, 18, 231);
        AddSpriteFrame(-28, -14, 16, 24, 35, 231);
    }
    if (playerListPos == 1) {
        AddSpriteFrame(-28, -14, 16, 24, 122, 202);
        AddSpriteFrame(-28, -14, 16, 24, 139, 202);
        AddSpriteFrame(-28, -14, 16, 24, 156, 202);
    }
    AddSpriteFrame(0, 0, 128, 32, 0, 128);
    AddSpriteFrame(0, -19, 128, 32, 0, 160);
    AddSpriteFrame(-6, 7, 128, 3, 0, 193);
    switch (Engine.language) {
        case 0:
        case 5:
        AddSpriteFrame(0, -5, 65, 11, 0, 197);
        AddSpriteFrame(0, -5, 55, 11, 66, 197);
        AddSpriteFrame(0, -5, 30, 11, 0, 209);
        AddSpriteFrame(0, -5, 64, 11, 31, 209);
        AddSpriteFrame(0, -5, 55, 11, 52, 244);
        break;
        case 1:
        AddSpriteFrame(0, -5, 73, 11, 0, 197);
        AddSpriteFrame(0, -5, 95, 11, 0, 209);
        AddSpriteFrame(0, -5, 53, 11, 148, 244);
        AddSpriteFrame(0, -5, 23, 11, 96, 209);
        AddSpriteFrame(0, -5, 95, 11, 52, 244);
        break;
        case 2:
        AddSpriteFrame(0, -5, 65, 11, 0, 197);
        AddSpriteFrame(0, -5, 78, 11, 0, 209);
        AddSpriteFrame(0, -5, 28, 11, 66, 197);
        AddSpriteFrame(0, -5, 23, 11, 79, 209);
        AddSpriteFrame(0, -5, 78, 11, 52, 244);
        break;
        case 3:
        AddSpriteFrame(0, -5, 48, 11, 0, 197);
        AddSpriteFrame(0, -5, 65, 11, 0, 209);
        AddSpriteFrame(0, -5, 71, 11, 49, 197);
        AddSpriteFrame(0, -5, 23, 11, 66, 209);
        AddSpriteFrame(0, -5, 65, 11, 52, 244);
        break;
        case 4:
        AddSpriteFrame(0, -5, 73, 11, 0, 197);
        AddSpriteFrame(0, -5, 67, 11, 0, 209);
        AddSpriteFrame(0, -5, 36, 11, 74, 197);
        AddSpriteFrame(0, -5, 23, 11, 68, 209);
        AddSpriteFrame(0, -5, 67, 11, 52, 244);
        break;
    }
}

void O_Special_PauseMenu::ObjectMain()
{
    Entity *self = Self();
...
void O_Special_PauseMenu::ObjectDraw()
{
    Entity *self = Self();
