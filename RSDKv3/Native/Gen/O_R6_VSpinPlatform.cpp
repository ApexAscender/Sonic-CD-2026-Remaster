...
#include "O_R6_VSpinPlatform.hpp"
...
// AUTO-GENERATED from VSpinPlatform.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R6_VSpinPlatform::ObjectStartup()
{
    ...
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("V Spin Platform")) {
...
void O_R6_VSpinPlatform::ObjectMain()
{
    Entity *self = Self();
...
void O_R6_VSpinPlatform::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R6_VSpinPlatform::ObjectDraw()
{
    Entity *self = Self();
