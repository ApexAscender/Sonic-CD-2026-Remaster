...
// AUTO-GENERATED from WaterStreamU.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_WaterStreamU::ObjectStartup()
{
...
void O_R4_WaterStreamU::ObjectPlayerInteraction()
{
    Entity *self = Self();
