...
#include "O_TitleCards_R8_TitleCard.hpp"
...
// AUTO-GENERATED from R8_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R8_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    if (GVar("Options.Soundtrack") == 0) {
        ...
        switch (objectEntityList[24].propertyValue) {
            case 0:
            SetMusicTrack_Script("US/R8A.ogg", 0, 1);
            break;
            case 1:
            SetMusicTrack_Script("R8B.ogg", 0, 145748);
            break;
            case 2:
            SetMusicTrack_Script("US/R8C.ogg", 0, 1);
            break;
            case 3:
            SetMusicTrack_Script("US/R8D.ogg", 0, 563962);
            break;
        }
    }
    ...
    objectEntityList[20].values[1] += objectEntityList[20].values[7];
    objectEntityList[20].values[2] = 15;
    ...
    AddSpriteFrame(0, 0, 20, 55, 159, 133);
    AddSpriteFrame(20, 32, 9, 23, 88, 84);
    AddSpriteFrame(29, 32, 10, 23, 81, 108);
    AddSpriteFrame(39, 32, 11, 23, 43, 84);
    AddSpriteFrame(51, 32, 9, 23, 159, 84);
    AddSpriteFrame(60, 32, 9, 23, 159, 84);
    AddSpriteFrame(69, 32, 6, 23, 169, 108);
    AddSpriteFrame(76, 32, 9, 23, 176, 108);
    AddSpriteFrame(0, 56, 20, 55, 159, 133);
    AddSpriteFrame(20, 56, 11, 23, 43, 84);
    AddSpriteFrame(32, 56, 11, 23, 76, 84);
    AddSpriteFrame(43, 56, 11, 23, 187, 84);
    AddSpriteFrame(55, 56, 9, 23, 88, 84);
    AddSpriteFrame(64, 56, 10, 23, 70, 108);
    AddSpriteFrame(74, 56, 10, 23, 70, 108);
}

void O_TitleCards_R8_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R8_TitleCard::ObjectDraw()
{
    Entity *self = Self();
