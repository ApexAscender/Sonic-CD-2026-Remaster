...
// AUTO-GENERATED from Boss_Leg.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R1_Boss_Leg::ObjectStartup()
{
    LoadSpriteSheet("R1/Objects3.gif");
    AddSpriteFrame(-12, -20, 24, 40, 74, 1);
}

void O_R1_Boss_Leg::ObjectMain()
{
    Entity *self = Self();
    ...
    switch (self->state) {
        ...
        if (self->values[6] < 0x80000) {
            ...
            if (scriptEng.tempValue[0] == 1) {
                ...
                BossLeg_SaveLegPosition();
            } else {
                BossLeg_HandleMovement();
            }
        } else {
            BossLeg_HandleMovement();
        }
...
void O_R1_Boss_Leg::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R1_Boss_Leg::ObjectDraw()
{
    DrawSprite_Frame(0);
}

void O_R1_Boss_Leg::BossLeg_SaveLegPosition()
{
    Entity *self = Self();
...
void O_R1_Boss_Leg::BossLeg_HandleMovement()
{
    Entity *self = Self();
...
const Native::NativeFunctionDef O_R1_Boss_Leg::funcs[2] = {
    { "BossLeg_SaveLegPosition", O_R1_Boss_Leg::BossLeg_SaveLegPosition },
    { "BossLeg_HandleMovement", O_R1_Boss_Leg::BossLeg_HandleMovement },
};
