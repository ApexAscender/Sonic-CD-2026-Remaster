...
#include "O_Animals_R4_YellowFish.hpp"
...
// AUTO-GENERATED from R4_YellowFish.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Animals_R4_YellowFish::ObjectStartup()
{
...
void O_Animals_R4_YellowFish::ObjectMain()
{
    Entity *self = Self();
...
void O_Animals_R4_YellowFish::ObjectDraw()
{
    Entity *self = Self();
