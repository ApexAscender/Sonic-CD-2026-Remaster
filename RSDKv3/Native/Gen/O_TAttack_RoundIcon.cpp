...
#include "O_TAttack_RoundIcon.hpp"
...
// AUTO-GENERATED from RoundIcon.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TAttack_RoundIcon::ObjectStartup()
{
    ...
    AddSpriteFrame(-32, 15, 64, 16, 70, 577);
    AddSpriteFrame(-32, 15, 64, 16, 135, 577);
    AddSpriteFrame(-32, 15, 64, 16, 200, 577);
    AddSpriteFrame(-32, 15, 64, 16, 265, 577);
    AddSpriteFrame(-32, 15, 64, 16, 70, 593);
    AddSpriteFrame(-32, 15, 64, 16, 135, 593);
    AddSpriteFrame(-32, 15, 64, 16, 200, 593);
    ...
    AddSpriteFrame(20, 16, 8, 13, 330, 604);
    scriptEng.arrayPosition[0] = 32;
    while (scriptEng.arrayPosition[0] < 1056) {
        if (objectEntityList[scriptEng.arrayPosition[0]].type == TypeNameID("Round Icon")) {
    ...
    faceBuffer[0].c = 2;
    faceBuffer[0].d = 3;
    faceBuffer[0].flags = 1;
}

void O_TAttack_RoundIcon::ObjectMain()
{
}

void O_TAttack_RoundIcon::ObjectDraw()
{
    Entity *self = Self();
