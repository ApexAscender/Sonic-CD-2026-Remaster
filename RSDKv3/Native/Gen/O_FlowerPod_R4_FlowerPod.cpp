...
#include "O_FlowerPod_R4_FlowerPod.hpp"
...
// AUTO-GENERATED from R4_FlowerPod.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_FlowerPod_R4_FlowerPod::ObjectStartup()
{
    LoadSpriteSheet("R4/Objects2.gif");
    AddSpriteFrame(-32, 6, 64, 42, 191, 213);
    AddSpriteFrame(-32, -48, 64, 54, 191, 159);
    AddSpriteFrame(-32, -48, 64, 54, 126, 184);
    AddSpriteFrame(-32, -10, 64, 16, 126, 239);
...
void O_FlowerPod_R4_FlowerPod::ObjectMain()
{
    Entity *self = Self();
...
void O_FlowerPod_R4_FlowerPod::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_FlowerPod_R4_FlowerPod::ObjectDraw()
{
    Entity *self = Self();
