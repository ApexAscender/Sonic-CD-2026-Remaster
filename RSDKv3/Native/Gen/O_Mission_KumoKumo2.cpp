...
#include "O_Mission_KumoKumo2.hpp"
...
// AUTO-GENERATED from KumoKumo2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_KumoKumo2::ObjectStartup()
{
...
void O_Mission_KumoKumo2::ObjectMain()
{
    Entity *self = Self();
...
void O_Mission_KumoKumo2::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_Mission_KumoKumo2::ObjectDraw()
{
    Entity *self = Self();
