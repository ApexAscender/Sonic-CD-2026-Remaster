...
#include "O_Mission_Boss_ArmJoint2.hpp"
...
// AUTO-GENERATED from Boss_ArmJoint2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Mission_Boss_ArmJoint2::ObjectStartup()
{
    LoadSpriteSheet("R1/Objects3.gif");
    AddSpriteFrame(-8, -8, 16, 16, 124, 34);
}

void O_Mission_Boss_ArmJoint2::ObjectMain()
{
    Entity *self = Self();
    ...
    switch (self->state) {
        ...
        self->state = 3;
        self->values[6] = 2;
        self->values[6] *= self->propertyValue;
        self->values[6] /= 10;
        case 1:
...
void O_Mission_Boss_ArmJoint2::ObjectDraw()
{
    DrawSprite_Frame(0);
}

void O_Mission_Boss_ArmJoint2::BossArmJoint2_HandleMovement()
{
    Entity *self = Self();
...
const Native::NativeFunctionDef O_Mission_Boss_ArmJoint2::funcs[1] = {
    { "BossArmJoint2_HandleMovement", O_Mission_Boss_ArmJoint2::BossArmJoint2_HandleMovement },
};
