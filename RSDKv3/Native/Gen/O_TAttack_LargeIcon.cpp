...
#include "O_TAttack_LargeIcon.hpp"
...
// AUTO-GENERATED from LargeIcon.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TAttack_LargeIcon::ObjectStartup()
{
    LoadSpriteSheet("TAttack/TimeAttack.gif");
    AddSpriteFrame(-64, -72, 128, 144, 0, 0);
    AddSpriteFrame(-64, -72, 128, 144, 256, 0);
    AddSpriteFrame(-64, -72, 128, 144, 384, 0);
    AddSpriteFrame(-64, -72, 128, 144, 0, 144);
    AddSpriteFrame(-64, -72, 128, 144, 128, 144);
    AddSpriteFrame(-64, -72, 128, 144, 256, 144);
    AddSpriteFrame(-64, -72, 128, 144, 384, 144);
...
void O_TAttack_LargeIcon::ObjectMain()
{
    Entity *self = Self();
...
void O_TAttack_LargeIcon::ObjectDraw()
{
    Entity *self = Self();
