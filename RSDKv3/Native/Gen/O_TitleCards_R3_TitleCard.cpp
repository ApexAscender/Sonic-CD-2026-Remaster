...
#include "O_TitleCards_R3_TitleCard.hpp"
...
// AUTO-GENERATED from R3_TitleCard.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_TitleCards_R3_TitleCard::ObjectStartup()
{
    if (playerListPos == 0) {
    ...
    if (GVar("Options.Soundtrack") == 0) {
        ...
        switch (objectEntityList[24].propertyValue) {
            case 0:
            SetMusicTrack_Script("US/R3A.ogg", 0, 1);
            break;
            case 1:
            SetMusicTrack_Script("R3B.ogg", 0, 166278);
            break;
            case 2:
            SetMusicTrack_Script("US/R3C.ogg", 0, 173494);
            break;
            case 3:
            SetMusicTrack_Script("US/R3D.ogg", 0, 1);
            break;
        }
    }
    ...
    AddSpriteFrame(0, 0, 16, 55, 66, 133);
    AddSpriteFrame(16, 32, 11, 23, 199, 84);
    AddSpriteFrame(28, 32, 9, 23, 159, 84);
    AddSpriteFrame(37, 32, 9, 23, 159, 84);
    AddSpriteFrame(46, 32, 6, 23, 169, 108);
    AddSpriteFrame(53, 32, 10, 23, 70, 108);
    AddSpriteFrame(64, 32, 6, 23, 169, 108);
    AddSpriteFrame(71, 32, 11, 23, 199, 84);
    AddSpriteFrame(83, 32, 11, 23, 187, 84);
    AddSpriteFrame(0, 56, 16, 55, 66, 133);
    AddSpriteFrame(16, 56, 11, 23, 119, 84);
    AddSpriteFrame(28, 56, 11, 23, 43, 84);
    AddSpriteFrame(40, 56, 11, 23, 199, 84);
    AddSpriteFrame(52, 56, 10, 23, 70, 108);
}

void O_TitleCards_R3_TitleCard::ObjectPlayerInteraction()
{
    pTimer() = 0;
}

void O_TitleCards_R3_TitleCard::ObjectDraw()
{
    Entity *self = Self();
