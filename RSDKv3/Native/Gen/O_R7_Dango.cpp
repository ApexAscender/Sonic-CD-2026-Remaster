...
void O_R7_Dango::ObjectStartup()
{
    LoadSpriteSheet("R7/Objects.gif");
    AddSpriteFrame(-16, -7, 32, 24, 116, 121);
    AddSpriteFrame(-16, -7, 32, 24, 149, 121);
    AddSpriteFrame(-16, -7, 32, 24, 116, 146);
    AddSpriteFrame(-16, -7, 32, 24, 149, 146);
    AddSpriteFrame(-16, -16, 32, 32, 51, 219);
    AddSpriteFrame(-16, -16, 32, 32, 84, 219);
    AddSpriteFrame(-16, -15, 32, 32, 51, 186);
    AddSpriteFrame(-16, -15, 32, 32, 117, 186);
    AddSpriteFrame(-16, -16, 32, 32, 84, 186);
    AddSpriteFrame(-16, -15, 32, 32, 51, 186);
...
void O_R7_Dango::ObjectPlayerInteraction()
{
    Entity *self = Self();
