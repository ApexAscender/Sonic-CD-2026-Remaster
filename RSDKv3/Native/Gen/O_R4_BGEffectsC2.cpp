...
// AUTO-GENERATED from BGEffectsC2.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R4_BGEffectsC2::ObjectStartup()
{
    ...
    while (scriptEng.tempValue[0] < 4) {
        LoadPalette("R4C_PalCycle.act", scriptEng.tempValue[0], 176, scriptEng.tempValue[1], scriptEng.tempValue[2]);
...
void O_R4_BGEffectsC2::ObjectDraw()
{
    Entity *self = Self();
...
void O_R4_BGEffectsC2::BGEffects_Deform_Left()
{
...
void O_R4_BGEffectsC2::BGEffects_Deform_Right()
{
    bgDeformationData1[scriptEng.arrayPosition[0]] = -1;
    scriptEng.arrayPosition[0]++;
    bgDeformationData1[scriptEng.arrayPosition[0]] = -1;
...
const Native::NativeFunctionDef O_R4_BGEffectsC2::funcs[2] = {
    { "BGEffects_Deform_Left", O_R4_BGEffectsC2::BGEffects_Deform_Left },
    { "BGEffects_Deform_Right", O_R4_BGEffectsC2::BGEffects_Deform_Right },
};
