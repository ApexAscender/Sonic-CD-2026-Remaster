...
#include "O_Credits_TextFont3.hpp"
...
// AUTO-GENERATED from TextFont3.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_Credits_TextFont3::ObjectStartup()
{
    LoadSpriteSheet("Menu/CreditsText.gif");
    AddSpriteFrame(-3, -9, 8, 16, 37, 35);
    scriptEng.tempValue[1] = 88;
    while (scriptEng.tempValue[1] < 110) {
    ...
    AddSpriteFrame(-3, -8, 8, 13, 37, 110);
    AddSpriteFrame(-3, -8, 8, 13, 46, 110);
    AddSpriteFrame(-3, -8, 8, 13, 55, 110);
    AddSpriteFrame(-3, -8, 8, 13, 64, 110);
}

void O_Credits_TextFont3::ObjectDraw()
{
    Entity *self = Self();
