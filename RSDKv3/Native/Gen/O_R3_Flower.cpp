...
void O_R3_Flower::ObjectStartup()
{
    LoadSpriteSheet("R3/Objects2.gif");
    AddSpriteFrame(-4, -8, 8, 16, 246, 25);
    AddSpriteFrame(-4, -8, 8, 16, 246, 42);
    AddSpriteFrame(-8, -16, 16, 16, 147, 67);
    AddSpriteFrame(-8, -16, 16, 16, 164, 67);
    AddSpriteFrame(-8, -16, 16, 16, 1, 50);
