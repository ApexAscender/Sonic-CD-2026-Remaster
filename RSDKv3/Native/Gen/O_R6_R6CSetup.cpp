...
// AUTO-GENERATED from R6CSetup.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R6_R6CSetup::ObjectStartup()
{
...
void O_R6_R6CSetup::ObjectPlayerInteraction()
{
    Entity *self = Self();
