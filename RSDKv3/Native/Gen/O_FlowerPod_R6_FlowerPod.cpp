...
#include "O_FlowerPod_R6_FlowerPod.hpp"
...
// AUTO-GENERATED from R6_FlowerPod.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_FlowerPod_R6_FlowerPod::ObjectStartup()
{
...
void O_FlowerPod_R6_FlowerPod::ObjectMain()
{
    Entity *self = Self();
...
void O_FlowerPod_R6_FlowerPod::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_FlowerPod_R6_FlowerPod::ObjectDraw()
{
    Entity *self = Self();
