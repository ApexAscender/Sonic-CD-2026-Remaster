...
#include "O_R1_Boss_LegJoint.hpp"
...
// AUTO-GENERATED from Boss_LegJoint.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R1_Boss_LegJoint::ObjectStartup()
{
    LoadSpriteSheet("R1/Objects3.gif");
    AddSpriteFrame(-8, -8, 16, 16, 74, 42);
}

void O_R1_Boss_LegJoint::ObjectMain()
{
    Entity *self = Self();
...
void O_R1_Boss_LegJoint::ObjectDraw()
{
    DrawSprite_Frame(0);
}

void O_R1_Boss_LegJoint::BossLegJoint_JointRotation()
{
    Entity *self = Self();
...
void O_R1_Boss_LegJoint::BossLegJoint_HandleMovement()
{
    Entity *self = Self();
...
void O_R1_Boss_LegJoint::BossLegJoint_HandleLanding()
{
    Entity *self = Self();
...
const Native::NativeFunctionDef O_R1_Boss_LegJoint::funcs[3] = {
    { "BossLegJoint_JointRotation", O_R1_Boss_LegJoint::BossLegJoint_JointRotation },
    { "BossLegJoint_HandleMovement", O_R1_Boss_LegJoint::BossLegJoint_HandleMovement },
    { "BossLegJoint_HandleLanding", O_R1_Boss_LegJoint::BossLegJoint_HandleLanding },
};
