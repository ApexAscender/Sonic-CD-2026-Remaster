...
#include "O_R5_HPlatformSmall.hpp"
...
// AUTO-GENERATED from HPlatformSmall.txt by retroscript2cpp.py. Faithful transliteration;
// review, then move to hand-maintained once verified.

void O_R5_HPlatformSmall::ObjectStartup()
{
...
void O_R5_HPlatformSmall::ObjectMain()
{
    Entity *self = Self();
...
void O_R5_HPlatformSmall::ObjectPlayerInteraction()
{
    Entity *self = Self();
...
void O_R5_HPlatformSmall::ObjectDraw()
{
    Entity *self = Self();
